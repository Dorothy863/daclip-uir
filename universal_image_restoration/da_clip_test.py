...
checkpoint = '/workspace/sd_models/daclip-uir-ViT-B-32-irsde/daclip_ViT-B-32.pt'
model, preprocess = open_clip.create_model_from_pretrained('daclip_ViT-B-32', pretrained=checkpoint)
tokenizer = open_clip.get_tokenizer('ViT-B-32')

image = preprocess(Image.open("universal-image-restoration/haze_01.jpg")).unsqueeze(0)
